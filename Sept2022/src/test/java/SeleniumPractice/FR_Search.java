...
//		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", notice);
		...
		List<WebElement> docslist17 = driver.findElements(By.xpath("//div[@class='document-wrapper']//child::h5//a"));
		for (int i = 0; i < docslist.size(); i++) {
			if (titlenum.equals("12")) {
//				WebElement founddocument = driver.findElement(By.id("item-count"));
//				System.out.println(founddocument.getText());
				System.out.println("............................");
				System.out.println(i + ") " + docslist.get(i).getText());
				docslist.get(i).click();
				List<WebElement> cfr = driver.findElements(By.xpath("//dd[contains(text(),'12 C')]"));
...
//				WebElement size17 = driver.findElement(By.id("item-count"));
//				System.out.println(size17.getText());
				System.out.println("............................");
				System.out.println(i + ") " + docslist17.get(i).getText());
				docslist17.get(i).click();
				List<WebElement> cfr = driver.findElements(By.xpath("//dd[contains(text(),'17 C')]"));
				for (WebElement cfr17 : cfr) {
					System.out.println(cfr17.getText());
				}
				Thread.sleep(5000);
				driver.navigate().back();
				Thread.sleep(5000);
