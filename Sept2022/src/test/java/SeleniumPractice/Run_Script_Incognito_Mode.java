...
public class Run_Script_Incognito_Mode {
	...
	public static void main(String[] args) {
		...
		List<WebElement> prizes = driver
				.findElements(By.xpath("//table[@id='product' and @name='courses']/tbody/tr/td[3]"));
		...
		System.out.println();
		List<WebElement> amounts = driver.findElements(By
				.xpath("//legend[text()='Web Table Fixed header']/parent::fieldset/descendant::tr/descendant::td[4]"));
